...
/**
 * Texture is a support class for the QCAR samples applications. Exposes
 * functionality for loading a texture from the APK or from a Bitmap.
 *
 * */
public class Texture
{
    ...
    /** Factory function to load a texture from a int buffer */
    public static Texture loadTextureFromIntBuffer(int[]data, int width, int height)
    {
        // Convert:
        byte[] dataBytes = new byte[width * height * 4];
